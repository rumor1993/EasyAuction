$(document).ready(function() {
        ...
        series : [
            {
                ...
                data:[usageCount[0], usageCount[1], usageCount[2], usageCount[3],
                	usageCount[4], usageCount[5], usageCount[6], usageCount[7],
                	usageCount[8], usageCount[9], usageCount[10], usageCount[11]]
            }
        ]
    };
        ...
        series : [
            {
                name:'일반물품',
                type:'bar',
                data:[CRegCount[0], CRegCount[1], CRegCount[2], CRegCount[3],
                	CRegCount[4], CRegCount[5], CRegCount[6], CRegCount[7],
                	CRegCount[8], CRegCount[9], CRegCount[10], CRegCount[11]],
            ...
            },
            {
                name:'특별물품',
                type:'bar',
                data:[SRegCount[0], SRegCount[1], SRegCount[2], SRegCount[3],
                	SRegCount[4], SRegCount[5], SRegCount[6], SRegCount[7],
                	SRegCount[8], SRegCount[9], SRegCount[10], SRegCount[11]],
    ...
    option = null;
    option = {
        color: ['#A7EEFF','#FF848F', '#5CE75C','#8c008c', '#FDD7A0', '#FF8200',
        	'#00A5FF', '#FFD732','#aaaaaa', '#7B68EE', '#37C3C3','#B86824'],
        tooltip : {
            trigger: 'item',
        ...
        legend: {
            orient : 'vertical',
            x : 'left',
            data:['패션의류','패션잡화','유아용품','가구/생활','식품', '취미','디지털/컴퓨터',
            	'스포츠/레저','뷰티','생활가전', '자동차공구', '도서/기타']
        },
        calculable : true,
        series : [
            {
                ...
                center: ['60%', '50%'],
                data:[
                	{value:cRegCateCount[0], name:'패션의류'},
                    {value:cRegCateCount[1], name:'패션잡화'},
                    {value:cRegCateCount[2], name:'유아용품'},
                    {value:cRegCateCount[3], name:'가구/생활'},
                    {value:cRegCateCount[4], name:'식품'},
                    {value:cRegCateCount[5], name:'취미'},
                    {value:cRegCateCount[6], name:'디지털/컴퓨터'},
                    {value:cRegCateCount[7], name:'스포츠/레저'},
                    {value:cRegCateCount[8], name:'뷰티'},
                    {value:cRegCateCount[9], name:'생활가전'},
                    {value:cRegCateCount[10], name:'자동차공구'},
                    {value:cRegCateCount[11], name:'도서/기타'}
                ]
            }
        ]
    };
        ...
        series : [
            {
                ...
                center: ['60%', '50%'],
                data:[
                	{value:sRegCateCount[0], name:'패션의류'},
                    {value:sRegCateCount[1], name:'패션잡화'},
                    {value:sRegCateCount[2], name:'유아용품'},
                    {value:sRegCateCount[3], name:'가구/생활'},
                    {value:sRegCateCount[4], name:'식품'},
                    {value:sRegCateCount[5], name:'취미'},
                    {value:sRegCateCount[6], name:'디지털/컴퓨터'},
                    {value:sRegCateCount[7], name:'스포츠/레저'},
                    {value:sRegCateCount[8], name:'뷰티'},
                    {value:sRegCateCount[9], name:'생활가전'},
                    {value:sRegCateCount[10], name:'자동차공구'},
                    {value:sRegCateCount[11], name:'도서/기타'}
                ]
            }
        ]
    };
